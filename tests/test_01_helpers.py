...
# Dict operations
def test_get_if_dict():
    assert get_if_dict({"key": "value"}, "key") == "value"
    assert get_if_dict({"key": "value"}, ["key"]) == "value"
...
def test_stretch_to_list_of_dicts():
    stretched_dict = stretch_to_list_of_dicts({"chuck": [1]})
    assert stretched_dict == [{"chuck": 1}]

    stretched_dict = stretch_to_list_of_dicts({"chuck": [[1, 2]], "norris": [[1, 2]]})
    assert stretched_dict == [{"chuck": 1, "norris": 1}, {"chuck": 2, "norris": 2}]

    stretched_dict = stretch_to_list_of_dicts({"chuck": [[1, 2, 3]], "norris": [[1, 2], [1]]})
    ...
    stretched_dict = stretch_to_list_of_dicts({"chuck": [[1, 2]], "norris": [[1], [1, 2, 3]]})
    assert stretched_dict == [
        {"chuck": 1, "norris": [1, 1]},
