...
def download_extract_zip(url:str, target_path:StrPath, expected_hash:str=None):
    """
...
def main():
    ...
    match system.lower():
        ...
        case _:
            raise(SystemError(f"System {system} not known. Only Windows, MacOS and Linux are supported."))
