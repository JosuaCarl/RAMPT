...
def test_msconv_pipe_main():
    args = argparse.Namespace(in_dir=helpers.construct_path(filepath, "..", "test_files"),
                              ...
                              redo_threshold=None, overwrite=None, workers=None, nested=True,
                              platform=platform, verbosity=0, msconv_arguments=None, save_log=False)
    ...
    with open( helpers.construct_path(filepath, "..", "out/minimal_file.mzML") ) as f:
        ...
        assert file.get('location') + "/" +  file.get('name') ==  "file:///" + helpers.construct_path(filepath, "..", "test_files/minimal_file.mzML")
    ...
    with open(helpers.construct_path(filepath, "..", "out/minimal_file.mzXML")) as f:
        ...
        assert file.get('fileName') ==  "file:///" + helpers.construct_path(filepath, "..", "test_files/minimal_file.mzXML")
